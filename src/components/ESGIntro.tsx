    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-soft">
        <div className="max-w-6xl mx-auto px-6 lg:px-10 pt-20 pb-24 lg:pt-28 lg:pb-32 relative">
          ...
          >
            ...
            <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl text-primary leading-[1.05] tracking-tight mb-6 font-bold">
              ...
              {benefits.map((b, i) => (
                <div key={b.text} className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0">
                    <b.icon className="h-4 w-4 text-primary" strokeWidth={1.75} />
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={s.label} className="flex items-baseline gap-4">
              <span className="font-heading text-4xl text-primary font-bold">{s.num}</span>
              <div>
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-10 py-20">
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="font-heading text-4xl sm:text-5xl text-primary leading-tight tracking-tight font-bold">
      ...
      <section className="bg-hero text-primary-foreground">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 py-20 text-center">
          <h2 className="font-heading text-4xl sm:text-5xl leading-tight mb-6 font-bold">
